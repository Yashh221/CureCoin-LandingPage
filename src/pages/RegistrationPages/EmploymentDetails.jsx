    ...
    <React.Fragment>
      {showEmploymentDetailsForm && (
        <div className="w-full">
          ...
          <button
            className="w-[150px] h-[40px] mt-[50px] font-bold text-tertiary hover:text-red-600 bg-red-600 hover:border-2 hover:border-solid hover:border-red-600 hover:bg-tertiary text-lg"
